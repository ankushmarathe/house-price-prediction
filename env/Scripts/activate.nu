...
let virtual-env = "D:\Ankush Files\Visual Studio Code\python\python_flask\env"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Ankush Files\Visual Studio Code\python\python_flask\env\Scripts\deactivate.nu"
